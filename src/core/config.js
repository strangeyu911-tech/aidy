...
function readConfig() {
  ...
  return {
    ...
    ownerUserId: readTextEnv("CYBERBOSS_OWNER_USER_ID"),
    ...
    providerProfilesFile: path.join(stateDir, "provider-profiles.json"),
    credentialVaultFile: path.join(stateDir, "credential-vault.json"),
    diagnosticCaptureFile: path.join(stateDir, "diagnostic-capture.json"),
    bridgeControlPort: readIntEnv("CYBERBOSS_BRIDGE_CONTROL_PORT") || 0,
    ...
    personaPacksDir: path.resolve(__dirname, "..", "..", "templates", "personas"),
    ...
    codexMcpServersFile: readTextEnv("CYBERBOSS_MCP_SERVERS_FILE"),
